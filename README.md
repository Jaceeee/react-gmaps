...
To use run **npm start** on the console. All the components have been imported, yet commented out, on App.js. Replace the React Component being rendered with the example component of choice.
